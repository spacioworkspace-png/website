...
export function FloatingWhatsApp() {
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 z-50 inline-flex items-center gap-3 rounded-full bg-primary px-5 py-4 text-white shadow-2xl hover:shadow-primary/50 transition-all duration-300 group"
